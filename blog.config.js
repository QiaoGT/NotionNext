...
const BLOG = {
  ...
  // artalk 评论插件
  COMMENT_ARTALK_SERVER: process.env.NEXT_PUBLIC_COMMENT_ARTALK_SERVER || 'https://twikoo-comment-eta-three.vercel.app/', // ArtalkServert后端地址 https://artalk.js.org/guide/deploy.html
